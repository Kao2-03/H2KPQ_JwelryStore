...
if (count($search_results) > 0) {
    ...
    foreach ($search_results as $row) {
        ...
        echo "<td>" . $diachi . "</td>";
        echo "<td>
                <button class='btn btn-primary btn-sm' onclick='openEditPopup(\"$id\", \"$maNCC\", \"$ten\", \"$diachi\", \"$sdt\")'>Edit</button>
                <button class='btn btn-primary btn-sm' onclick='deleteSupplier(\"$id\")'>Delete</button>
              </td>";
        echo "</tr>";
    }
    echo "</tbody>";
