        ...
        <div id="main-container">
          ...
          <div id="nav-bar-ne">
            ...
            <div class="nav_ne">
              <nav class="nav flex-column">
                ...
                <a class="nav-link " href="phieuBan.html">Phiếu mua</a>
                <a class="nav-link active" href="dichVu.html">Phiếu dịch vụ</a>
          ...
          <div class="working-area">
            <div class="tab-container">
                <ul class="ul-tab">
                    <li class="tab_btn"><a href="dichVu.html"
                        style="text-decoration: none;">Lập phiếu</a></li>
                    <li class="tab_btn active"><a href="traCuuDichVu.html"
                        style="text-decoration: none;">Tra cứu</a></li>
                        <li class="tab_btn "><a href="danhMucDichVu.html"
